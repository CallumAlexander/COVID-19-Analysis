...
def plotDailyExtended(X, y, future, label, figure, axis, axX, axY):
    ...
    movingAverage7, X_mean7 = movingAverage7days(y)
    movingAverage14, X_mean14 = movingAverage2weeks(y)
    ...
    axis[axX, axY].plot(X_mean7, movingAverage7, label='1 week moving average')
    axis[axX, axY].plot(X_mean14, movingAverage14, label='2 week moving average')
